    ...
    <Card className="border-zinc-800 bg-zinc-900/50 backdrop-blur-sm">
      <CardHeader className="flex flex-row items-center space-y-0 pb-2">
        ...
        <div className="ml-auto flex items-center space-x-2">
          ...
          <Badge variant="outline" className={`${currentStatus.textColor} border-zinc-600`}>
            {currentStatus.text}
          </Badge>
        </div>
      </CardHeader>
...
const ServicePerformanceChart = ({ service, timeRange = '24h' }) => {
  ...
  if (loading) {
    return (
      <Card className="border-zinc-800 bg-zinc-900/50 backdrop-blur-sm">
        ...
        <CardContent>
          <div className="h-64 bg-zinc-700 rounded animate-pulse"></div>
        </CardContent>
      </Card>
    );
  }
  ...
  return (
    <Card className="border-zinc-800 bg-zinc-900/50 backdrop-blur-sm">
      <CardHeader>
        <CardTitle className="text-zinc-100">Performance Metrics</CardTitle>
        <CardDescription className="text-zinc-400">
    ...
    <div className={`space-y-6 ${className}`}>
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          <h2 className="text-2xl font-bold text-zinc-100">Service Metrics</h2>
